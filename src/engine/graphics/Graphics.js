...
function getHorizontalPx(unit) {
    return ~~(unitWidth * unit);
}

function getVerticalPx(unit) {
    return ~~(unitHeight * unit);
}
...
function createContext(contextType, contextAttributes) {
    ...
    try {
        ...
        setCanvasSize(viewportWidth, viewportHeight);
        return gl;
    } catch(ex) {
...
module.exports = {
    ...
    getHorizontalPx: getHorizontalPx,
    getVerticalPx: getVerticalPx,
